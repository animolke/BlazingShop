...
namespace BlazingShop.Server.Migrations
{
    ...
    [Migration("20210810221338_Seeding")]
            ...
            modelBuilder.Entity("BlazingShop.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 8, 11, 3, 43, 38, 286, DateTimeKind.Local).AddTicks(7794),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 8, 11, 3, 43, 38, 289, DateTimeKind.Local).AddTicks(32),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 8, 11, 3, 43, 38, 289, DateTimeKind.Local).AddTicks(52),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            DateCreated = new DateTime(2021, 8, 11, 3, 43, 38, 289, DateTimeKind.Local).AddTicks(54),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
